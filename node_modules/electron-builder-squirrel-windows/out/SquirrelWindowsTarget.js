...
class SquirrelWindowsTarget extends (_electronBuilderLib || _load_electronBuilderLib()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            (0, (_builderUtil || _load_builderUtil()).log)(`Building Squirrel.Windows for arch ${(_electronBuilderLib || _load_electronBuilderLib()).Arch[arch]}`);
            ...
            packager.dispatchArtifactCreated(_path.join(installerOutDir, setupFile), _this, arch, `${sanitizedName}-Setup-${version}${(0, (_electronBuilderLib || _load_electronBuilderLib()).getArchSuffix)(arch)}.exe`);
